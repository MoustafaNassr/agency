...
export const metadata = {
  title: "Design Agency || ApexNile - Creative Multipurpose React NextJS Template",
};
const DesignAgency = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 mb-30 d-flex justify-content-center justify-content-lg-end order-lg-3">
              <a
                href="mailto:support@ApexNile.com"
              ...
              >
                ...
                <span>support@ApexNile.com</span>
              </a>
            </div>
            {/* End .col-lg-4 */}
