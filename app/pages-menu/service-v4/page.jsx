...
export const metadata = {
  title: "Service V4 || ApexNile - Creative Multipurpose React NextJS Template",
};
const ServiceV4 = () => {
  return (
    <>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 ms-auto aos fadeInRight">
              <p className="text-lg text-center text-lg-start md-pt-30 m0">
                ApexNile provides alternative asset management solutions to a global
